...
import NonSuspenseUserPostList from '../without-suspense/UserPostList'
    ...
    <UserListItemInner {...rest}>
      <UserCard>
        <UserCard.Header>
          ...
          <UserCard.Header.ProfileImage title={user.name} alt={user.name}
        ...
        <UserCard.Body>
          <NonSuspenseUserPostList userId={user.id}/>
        </UserCard.Body>
      </UserCard>
    </UserListItemInner>
  )
